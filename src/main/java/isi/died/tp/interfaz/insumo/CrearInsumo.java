...
public class CrearInsumo extends JFrame {	// TODO Borrar la clase si solo se utiliza la de editar
	...
	public CrearInsumo(Insumo insumo) {
	...
	public static void main(String[] args) {
		...
		CrearInsumo crearInsumo = new CrearInsumo(insumo);
